...
master_dic_dataset_name = {'agriculture wages': 'rural_wages',
 ...
 'pca demography census': 'census', 'pca demography': 'census', 'census household': 'census_household', 'pm kissan':'pm_kissan', 'shc nutrient': 'shc_nutrient', 'shc fund': 'shc_fund', 'input composite': 'input_composite', 'input noncrop': 'input_noncrop', 'non agri': 'non_agri', 'nrga emp': 'nrga_emp', 'social education': 'social_education', 'rbi deposit':'rbi_deposit', 'debt invest':'debt_invest', 'rbi credit': 'rbi_credit'}
...
datset_name_and_ds_api_name = {"rural_wages" :"Agriculture Wages", "nabard":"Financial Inclusion Survey (NABARD)", "cpi" :"Consumer Price Index and Inflation (CPI)", "rbi_credit" :"Credit by Bank" ,"debt_invest" :"Debt and Investment (NSSO)" ,"rbi_deposit" :"Deposits with Bank" ,"plfs" :"Employment (NSSO)" ,"social_education" :"Household Consumption on Education (NSSO)" ,"nrega" :"MGNREGA - Agriculture Investments" ,"nrga_emp" :"MGNREGA - Employment" ,"non_agri" :"Unincorporated Non-Agriculture Enterprises Excluding Construction (NSSO)" ,"fis" :"Financial Inclusion Survey (NABARD)" ,"input_noncrop" :"Input survey (Non-Crop)" ,"nrlm" :"NRLM - Self Help Groups (SHGs)" ,"sas" :"Situation Assessment of Agricultural household (NSSO)" ,"agcensus_crop" :"Agricultural Census 2010-11 (Crop)" ,"agcensus_noncrop" :"Agricultural Census 2010-11 (Non-Crop)" ,"agcensus_c" :"Agricultural Census 2015-16 (Crop)" ,"agcensus_nc" :"Agricultural Census 2015-16 (Non-Crop)" ,"agmarknet" :"Agricultural Marketing (Agmarknet)" ,"nhb" :"Area Production Statistics (NHB)" ,"apy" :"Area Production Yield (APY)" ,"coc" :"Cost of Cultivation (CoC)" ,"fertiliser_sales" :"Fertiliser Sales" ,"subsidy" :"Food and Fertiliser Subsidy" ,"input_composite" :"Input Survey (Crop Composite)" ,"input_crop" :"Input Survey (Crop)" ,"nfsm" :"National Food Security Mission (NFSM) Spending" ,"procurement" :"Procurement of Foodgrains" ,"pds" :"Public Distribution System (PDS)" ,"shc_fund" :"Soil Health Card - Funding status" ,"shc_nutrient" :"Soil Health Card - Nutrient Status" ,"stock" :"Stock of Foodgrains" ,"depth" :"Depth to Water Level" ,"groundwater" :"Groundwater - Stages of Extraction" ,"rainfall" :"Rainfall" ,"soil" :"Soil" ,"temperature" :"Temperature" ,"pmfby" :"Crop Insurance - Pradhan Mantri Fasal Bima Yojana (PMFBY)" ,"msp" :"Minimum Support Price (MSP)" ,"pm_kissan" :"PM Kisan" ,"pmksy" :"Pradhan Mantri Krishi Sinchai Yojana (PMKSY)" ,"antyodaya" :"Mission Antyodaya" ,"secc" :"Socio-economic Caste Census (SECC)" ,"census_household" :"Census Household Amenities" ,"census" :"Census PCA Demography"}
